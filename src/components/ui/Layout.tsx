              ...
              <nav className="flex flex-col space-y-4">
                ...
                <ScrollArea className="h-[calc(100vh-8rem)] pb-10">
                  <div className="flex flex-col space-y-2">
                    <a href="/graduates" className="text-foreground/60 hover:text-foreground transition-colors">
                      Graduates
                    </a>
                    <a href="/projects" className="text-foreground/60 hover:text-foreground transition-colors">
                      Projects
                    </a>
                    <a href="/employers" className="text-foreground/60 hover:text-foreground transition-colors">
                      Employers
                    </a>
